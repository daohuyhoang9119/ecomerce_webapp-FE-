      ...
      <div className="modal-dialog modal-dialog-vertical" role="document">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="modal-body">
              ...
              <div className="input-group input-group-merge">
                  <input className="form-control" type="search" placeholder={t('Search')} name="input" value={form.input} onKeyPress={_keyPressSubmitSearch} onChange={inputOnChange} />

                  <div className="input-group-append">
                      <button className="btn btn-outline-border" type="submit" onClick={_submitSearch}>
          ...
          <div className="modal-body border-top font-size-sm">
            ...
            {/* Items */}
            {
              listSearch.map((item) => <SearchItem key={item._id} {...item} />)
            }
            {/* Button */}
