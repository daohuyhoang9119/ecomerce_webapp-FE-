                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="nav nav-tabs nav-overflow justify-content-start justify-content-md-center border-bottom">
                            <a className="nav-link active" data-toggle="tab" href="#descriptionTab">Thông tin chi tiết</a>
                            <a className="nav-link" data-toggle="tab" href="#sizeTab">Nhận xét của người mua</a>
                            <a className="nav-link" data-toggle="tab" href="#shippingTab">Câu hỏi thường gặp</a>
                        </div>
                        {/* Content */}
